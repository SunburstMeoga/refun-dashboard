    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 gap-4 mb-10 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
                <CardDataStats title="账号" total='2342342234'>
                    <svg
                ...
                <CardDataStats title="消费金额" total={userInfoData.order_cashback_remain} rate="4.35%" levelUp>
                    <svg
                        className="fill-primary dark:fill-white"
                        width="20"
                        height="22"
                ...
                <CardDataStats title="提供的加速奖励" total={userInfoData.order_cashback_remain} rate="4.35%" levelUp>
                    <svg
                        className="fill-primary dark:fill-white"
                        width="20"
                        height="22"
