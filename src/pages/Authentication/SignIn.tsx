...
const SignIn: React.FC = () => {
  ...
  let handlePhoneNumberChange = (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    <>
      <div className="flex justify-center items-center h-screen">
        <div className="rounded-sm border border-stroke bg-white shadow-default w-11/12 lg:w-8/12  dark:border-strokedark dark:bg-boxdark">
          <div className="flex flex-wrap items-center">
            ...
            <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
              <form className="w-full p-4 sm:p-12.5 xl:p-17.5">
                <span className="mb-1.5 block font-medium">免费开始</span>
                ...
                <div>
                  ...
                  <div className="mb-5">
                    <div
                      onClick={() => handleLogin()}
                      className="w-full cursor-pointer rounded-lg border flex justify-center items-center border-primary bg-primary p-4 text-white transition hover:bg-opacity-90"
                    >登录</div></div>
                </div>
